...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Voice'), ['action' => 'edit', $voice->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Voice'), ['action' => 'delete', $voice->id], ['confirm' => __('Are you sure you want to delete # {0}?', $voice->id)]) ?> </li>
        <li><?= $this->Html->link(__('List Voices'), ['action' => 'index']) ?> </li>
        <li><?= $this->Html->link(__('New Voice'), ['action' => 'add']) ?> </li>
